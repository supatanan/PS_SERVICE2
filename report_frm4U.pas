...
procedure Treport_frm4.cxButton1Click(Sender: TObject);
begin
  Close;
end;

procedure Treport_frm4.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.trainsaction_trype_id =3 and  '+
'tborder_service.date_service BETWEEN '''+FormatDateTime('yyyy-mm-dd', ds1.Date)+'''and  '''+FormatDateTime('yyyy-mm-dd',ds2.Date)+'''   ';
  ...
  ppReport1.Template.FileName := path + '\report\report4.rtm';
...
procedure Treport_frm4.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
    Resize := False;
end;

procedure Treport_frm4.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    Action := caFree;
    report_frm4 := nil;
...
procedure Treport_frm4.FormShow(Sender: TObject);
begin
  ds1.Date := Now;
  ds2.Date := Now;
