...
procedure Treport_frm5.cxButton1Click(Sender: TObject);
begin
  Close;
end;

procedure Treport_frm5.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.success_service_id=1    and  '+
'tborder_service.date_service BETWEEN '''+FormatDateTime('yyyy-mm-dd', ds1.Date)+'''and  '''+FormatDateTime('yyyy-mm-dd',ds2.Date)+'''   ';
  ...
  ppReport1.Template.FileName := path + '\report\report5.rtm';
  ppReport1.Template.LoadFromFile;

end;

procedure Treport_frm5.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
   Resize := False;
end;

procedure Treport_frm5.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    Action := caFree;
    report_frm5 := nil;
end;

procedure Treport_frm5.FormShow(Sender: TObject);
begin
  ds1.Date := Now;
  ds2.Date := Now;
