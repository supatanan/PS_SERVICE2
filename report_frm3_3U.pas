...
uses
  ...
  dxGDIPlusClasses, Vcl.ExtCtrls, RzPanel, ppBarCod;

type
  Treport_frm3_3 = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
    Panel2: TPanel;
...
procedure Treport_frm3_3.cxButton1Click(Sender: TObject);
begin
      Close;
end;

procedure Treport_frm3_3.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.trainsaction_trype_id = 2 and  '+
...
'tborder_service.date_service BETWEEN '''+FormatDateTime('yyyy-mm-dd', ds1.Date)+'''and  '''+FormatDateTime('yyyy-mm-dd',ds2.Date)+'''   ';
  ...
  open;
   ...
   ppReport1.Template.FileName := path + '\report\report3.rtm';
...
procedure Treport_frm3_3.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
   Resize := False;
end;

procedure Treport_frm3_3.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     Action := caFree;
     report_frm3_3 := nil;
end;

procedure Treport_frm3_3.FormShow(Sender: TObject);
begin
 ds1.Date := Now;
  ds2.Date := Now;
