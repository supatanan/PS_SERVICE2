...
procedure Treport_frm6.cxButton1Click(Sender: TObject);
begin
     Close;

end;

procedure Treport_frm6.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.success_service_id=0    and  '+
'tborder_service.date_service BETWEEN '''+FormatDateTime('yyyy-mm-dd', ds1.Date)+'''and  '''+FormatDateTime('yyyy-mm-dd',ds2.Date)+'''   ';
  ...
  ppReport1.Template.FileName := path + '\report\report6.rtm';
...
procedure Treport_frm6.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
   Resize := False;
end;

procedure Treport_frm6.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     Action := caFree;
     report_frm6 := nil;
end;

procedure Treport_frm6.FormShow(Sender: TObject);
begin
  ds1.Date := Now;
  ds2.Date := Now;
