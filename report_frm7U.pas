...
procedure Treport_frm7.cxButton1Click(Sender: TObject);
begin
  Close;
end;

procedure Treport_frm7.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.tbstatus_trype_id=1  and  '+
...
open;
  ...
  ppReport1.Template.FileName := path + '\report\report7.rtm';
  ppReport1.Template.LoadFromFile;

end;

procedure Treport_frm7.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
    Resize := False;
end;

procedure Treport_frm7.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   AcTion := caFree;
   report_frm7 := nil
end;

procedure Treport_frm7.FormShow(Sender: TObject);
begin
  ds1.Date := Now;
  ds2.Date := Now;
