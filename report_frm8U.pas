...
procedure Treport_frm8.cxButton1Click(Sender: TObject);
begin
 Close;
end;

procedure Treport_frm8.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.tbstatus_trype_id=2  and  '+
...
open;
  ...
  ppReport1.Template.FileName := path + '\report\report8.rtm';
  ppReport1.Template.LoadFromFile;

end;

procedure Treport_frm8.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
   Resize := False;
end;

procedure Treport_frm8.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Action := caFree;
   report_frm8 := nil;
end;

procedure Treport_frm8.FormShow(Sender: TObject);
begin
  ds1.Date := Now;
  ds2.Date := Now;
