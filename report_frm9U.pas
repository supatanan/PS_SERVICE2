...
procedure Treport_frm9.cxButton1Click(Sender: TObject);
begin
    Close;
end;

procedure Treport_frm9.cxButton2Click(Sender: TObject);
var
  path: string;
begin
...
' tborder_service.tbstatus_trype_id=3  and  '+
...
open;
  ...
  ppReport1.Template.FileName := path + '\report\report9.rtm';
  ppReport1.Template.LoadFromFile;

end;

procedure Treport_frm9.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
   Resize := False;
end;

procedure Treport_frm9.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    Action := caFree;
    report_frm9 := nil;
end;

procedure Treport_frm9.FormShow(Sender: TObject);
begin
  ds1.Date := Now;
  ds2.Date := Now;
